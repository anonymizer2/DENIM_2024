    ...
    def TestingLoss(self, input_sentence, input_EDU_breaks, LabelIndex, ParsingIndex, GenerateTree, use_pred_segmentation):
        ...
        for i in range(len(EDU_breaks)):
            ...
            if len(EDU_breaks[i]) == 1:
                ...
                Tree_batch.append([])
                Label_batch.append([])
                Logits_batch.append(cur_logits)
                if GenerateTree:
                ...
                cur_logits.append(relation_weights)
                Logits_batch.append(cur_logits)
        ...
        return Loss_tree_batch, Loss_label_batch, (SPAN_batch if GenerateTree else None), (merged_label_gold, merged_label_pred), EDU_breaks, Logits_batch
